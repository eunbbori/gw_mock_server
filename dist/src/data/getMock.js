...
export const getEmployeeWorkingConditional = (employees, startDt, endDt) => {
    ...
    return employeeWorkings.sort((e1, e2) => (!e1.startAt ? 1 : !e2.startAt ? -1 : e1.startAt < e2.startAt ? 1 : e1.startAt === e2.startAt ? 0 : -1));
};
...
export const getEmployeeWorking = (dt) => {
    ...
    return isToday(workingDate)
        ? employeeWorkingToday
        : workingDate.getDay() === 0 || workingDate.getDay() === 6
            ? []
            : employees
                .map((e) => {
